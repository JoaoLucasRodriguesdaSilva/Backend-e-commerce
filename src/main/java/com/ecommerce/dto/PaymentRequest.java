...
@Schema(description = "Request payload for creating or updating a payment")
public record PaymentRequest(
    ...
    @Schema(description = "Payment status: PENDING, APPROVED, DENIED, CANCELLED, REFUNDED", example = "PENDING")
    PaymentStatus status,

    @Schema(description = "Payment amount", example = "239.99")
    BigDecimal amount,

    @Schema(description = "Number of installments (relevant for credit card)", example = "3")
