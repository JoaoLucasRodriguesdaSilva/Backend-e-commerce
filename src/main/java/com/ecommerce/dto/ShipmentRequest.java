...
@Schema(description = "Request payload for creating or updating a shipment")
public record ShipmentRequest(
    @Schema(description = "ID of the order this shipment belongs to", example = "1")
    Long orderId,
    ...
    @Schema(description = "Shipment status: PENDING, SHIPPED, IN_TRANSIT, DELIVERED, LOST, RETURNED", example = "PENDING")
